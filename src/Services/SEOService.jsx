        ...
        <div className='relative flex flex-col pb-25 justify-center w-full items-center bg-gradient-to-b from-[#FFF4EB] to-white overflow-hidden select-none px-4'>
            <div className='flex flex-col justify-center mt-20 items-center'>
                ...
                <h3
                    ...
                    data-aos-delay="400"
                >
                    Want to rank your website higher on Google? <br className='md:hidden' />
                    Book a free <br className="hidden md:block" />
                    SEO consultation today and let's <br className='md:hidden' />
                ...
                >
                    <a
                        href="https://wa.me/919920655685?text=I%20want%20to%20know%20more%20about%20your%20SEO%20services"
                        target="_blank"
